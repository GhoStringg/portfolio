// ===== CPE Journey Page Specific JavaScript =====
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('⚙️ BSCPE Journey page loaded');

    document.body.classList.add('cpe-layout-active');
    ...
    // Auto-expand first gallery in each section
    document.querySelectorAll('.cpe-gallery .gallery-group:first-child').forEach(group => {
